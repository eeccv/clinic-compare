      ...
      <div className="flex">
        ...
        <main className="flex-1 mr-64 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-800">➕ إضافة صالون جديد</h1>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input name="address" value={form.address} onChange={handleChange}
                  placeholder="حي النزهة، شارع الأمير سلطان"
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-rose-400 text-right text-sm" />
              </div>
              ...
              <div>
                ...
                <textarea name="description" value={form.description} onChange={handleChange}
                  placeholder="وصف مختصر عن الصالون وخدماته..."
                  rows={3}
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={handleSubmit} disabled={loading}
                  ...
                  {loading ? '⏳ جاري الحفظ...' : '💾 حفظ الصالون'}
                </button>
              </div>
            </div>
          </div>
